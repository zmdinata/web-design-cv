...
try {
    ...
    // Membuat database jika belum ada dan memilihnya
    $conn->query("CREATE DATABASE IF NOT EXISTS `$dbname`");
    $conn->select_db($dbname);
    echo "Database `{$dbname}` siap digunakan.<br>";

    // Menghapus tabel lama untuk memastikan data bersih
    $conn->query("DROP TABLE IF EXISTS `bahasa`, `sertifikasi`, `keahlian`, `penghargaan`, `pengalaman`, `pendidikan`, `personal_info`");
    echo "Tabel lama berhasil dihapus (jika ada).<br>";

    // Fungsi bantuan untuk menjalankan query dan memeriksa error
    ...
    executeQuery($conn, "CREATE TABLE `personal_info` ( `id` int(11) NOT NULL AUTO_INCREMENT, `nama_lengkap` varchar(100) NOT NULL, `lokasi` varchar(100) DEFAULT NULL, `email` varchar(100) DEFAULT NULL, `linkedin` varchar(255) DEFAULT NULL, `ringkasan` text DEFAULT NULL, PRIMARY KEY (`id`) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;", "membuat tabel personal_info");
    executeQuery($conn, "CREATE TABLE `pendidikan` ( `id` int(11) NOT NULL AUTO_INCREMENT, `personal_info_id` int(11) DEFAULT NULL, `institusi` varchar(100) DEFAULT NULL, `gelar` varchar(100) DEFAULT NULL, `ipk` decimal(3,2) DEFAULT NULL, PRIMARY KEY (`id`) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;", "membuat tabel pendidikan");
    executeQuery($conn, "CREATE TABLE `pengalaman` ( `id` int(11) NOT NULL AUTO_INCREMENT, `personal_info_id` int(11) DEFAULT NULL, `posisi` varchar(100) DEFAULT NULL, `perusahaan` varchar(100) DEFAULT NULL, `tanggal_mulai` date DEFAULT NULL, `tanggal_selesai` date DEFAULT NULL, `deskripsi` text DEFAULT NULL, PRIMARY KEY (`id`) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;", "membuat tabel pengalaman");
    executeQuery($conn, "CREATE TABLE `penghargaan` ( `id` int(11) NOT NULL AUTO_INCREMENT, `personal_info_id` int(11) DEFAULT NULL, `judul` varchar(255) DEFAULT NULL, `deskripsi` text DEFAULT NULL, PRIMARY KEY (`id`) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;", "membuat tabel penghargaan");
    executeQuery($conn, "CREATE TABLE `keahlian` ( `id` int(11) NOT NULL AUTO_INCREMENT, `personal_info_id` int(11) DEFAULT NULL, `kategori` varchar(100) DEFAULT NULL, `skills` text DEFAULT NULL, PRIMARY KEY (`id`) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;", "membuat tabel keahlian");
    executeQuery($conn, "CREATE TABLE `sertifikasi` ( `id` int(11) NOT NULL AUTO_INCREMENT, `personal_info_id` int(11) DEFAULT NULL, `nama_sertifikasi` varchar(200) DEFAULT NULL, `penerbit` varchar(100) DEFAULT NULL, PRIMARY KEY (`id`) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;", "membuat tabel sertifikasi");
    executeQuery($conn, "CREATE TABLE `bahasa` ( `id` int(11) NOT NULL AUTO_INCREMENT, `personal_info_id` int(11) DEFAULT NULL, `nama_bahasa` varchar(50) DEFAULT NULL, `tingkat_kemahiran` varchar(50) DEFAULT NULL, PRIMARY KEY (`id`) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;", "membuat tabel bahasa");
    echo "Struktur tabel baru berhasil dibuat.<br>";

    // --- MEMASUKKAN SEMUA DATA CV ---
    // [ID 1] Data untuk Zacky Muhammad Dinata
    ...
    executeQuery($conn, "INSERT INTO `keahlian` (`personal_info_id`, `kategori`, `skills`) VALUES (1, 'Data & Database', 'Data Analysis, SQL Queries, MySQL, SQL, Database, Tableau, Python, Oracle Database'), (1, 'Design Ilustrator', 'Adobe Photoshop, Figma, UI Design, Grapich Design, Ilustrator')", "memasukkan data keahlian ID 1");
    ...
    // [ID 3] Data untuk Dikri Fauzan Anawawi
    ...
    executeQuery($conn, "INSERT INTO `pendidikan` (`personal_info_id`, `institusi`, `gelar`, `ipk`) VALUES (3, 'STMIK IKMI Cirebon', 'S1, Sistem Informasi', 4.00)", "memasukkan data pendidikan ID 3");
    ...
    // [ID 4] Data untuk Muhammad Hisyam Nudin
    ...
    // [ID 5] Data untuk Muhammad Zhaky Albaihaqy
    ...
    // [ID 6] Data untuk Tio Pramudya Berliana
